      ...
      <div className="relative rounded-2xl overflow-hidden mb-4 p-6 sm:p-8"
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-2xl sm:text-3xl font-black mb-1">
            <span className="gradient-text">ค้นหาหุ้นอเมริกา</span> S&P 500
          </h1>
          <p className="text-gray-400 text-sm">ข้อมูลหุ้นทั้งหมดในดัชนี S&P 500 · {STOCKS_DB.length} หุ้น · กรองตามเซกเตอร์ ขนาดตลาด หรือตลาดแลกเปลี่ยน</p>
        </div>
      </div>
